...
function paintersave(savepath::ASCIIString,PDATA::PAINTER_Data,OIDATA::PAINTER_Input,OPTOPT::OptOptions)
  ...
  "Folder",OIDATA.Folder, "FilesName",OIDATA.FilesName, "indfile",OIDATA.indfile,"indwvl",OIDATA.indwvl, "wvl",OIDATA.wvl, "U",OIDATA.U, "V",OIDATA.V, "P",OIDATA.P, "W",OIDATA.W
  ,"Xi",OIDATA.Xi, "K",OIDATA.K, "Closure_index",OIDATA.Closure_index, "nb",OIDATA.nb, "nw",OIDATA.nw, "nx",OIDATA.nx
  ,"FOV",OIDATA.FOV, "lambda_spat", OIDATA.lambda_spat,"lambda_spec", OIDATA.lambda_spec, "lambda_L1", OIDATA.lambda_L1
  ,"rho_y",OIDATA.rho_y, "rho_spat", OIDATA.rho_spat,"rho_spec",OIDATA.rho_spec,"rho_ps",OIDATA.rho_ps,"alpha",OIDATA.alpha
  ,"beta",OIDATA.beta,"eps1",OIDATA.eps1,"eps2",OIDATA.eps2,"epsilon",OIDATA.epsilon,"mask3D",OIDATA.mask3D,"xinit3D",OIDATA.xinit3D
  ,"Wvlt",OIDATA.Wvlt,"paral",OIDATA.paral)

  JLD.save(string("PDATA_",savepath),
   "eta", PDATA.eta,"plan", PDATA.plan,"F3D", PDATA.F3D,"H", PDATA.H,"M", PDATA.M,"x", PDATA.x,"vHt", PDATA.vHt,"z", PDATA.z
  ,"Hx", PDATA.Hx,"tau_s", PDATA.tau_s,"w", PDATA.w,"v", PDATA.v,"r", PDATA.r,"tau_w", PDATA.tau_w,"tau_v", PDATA.tau_v
  ,"tau_r", PDATA.tau_r,"Spcdct", PDATA.Spcdct,"Fx", PDATA.Fx,"tau_xc", PDATA.tau_xc,"tau_pwc", PDATA.tau_pwc
  ,"tau_xic", PDATA.tau_xic,"ys", PDATA.ys,"y_tampon", PDATA.y_tampon,"yc", PDATA.yc,"y_v2", PDATA.y_v2
  ,"y_phi", PDATA.y_phi,"crit1", PDATA.crit1,"crit2", PDATA.crit2,"ind", PDATA.ind,"CountPlot", PDATA.CountPlot
  ,"count", PDATA.count,"nbitermax", PDATA.nbitermax)
