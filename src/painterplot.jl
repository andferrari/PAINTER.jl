...
nw = OIDATA.nw
FOV = OIDATA.FOV
#    x::SharedArray,w::Array,crit1::Vector,crit2::Vector,eps1::Real,eps2::Real,nx::Int64,nw::Int64,wvl::Vector,FOV::Real)
...
#     imshow(x[:,:,n].*reshape(max(0,w[:,n]),nx,nx), origin ="lower")
